...
################################################################################
## Form generated from reading UI file 'Cópia de wind_addprod.ui'
##
...
class Ui_wind_add_prod(object):
    def setupUi(self, wind_add_prod):
        if not wind_add_prod.objectName():
            wind_add_prod.setObjectName(u"wind_add_prod")
        wind_add_prod.resize(827, 276)
        wind_add_prod.setMinimumSize(QSize(827, 276))
        wind_add_prod.setMaximumSize(QSize(827, 276))
        self.verticalLayout = QVBoxLayout(wind_add_prod)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.fr_top = QFrame(wind_add_prod)
        ...
        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.cb_fornec)
        ...
        self.fr_bot = QFrame(wind_add_prod)
...
"}")
        ...
        self.retranslateUi(wind_add_prod)

        QMetaObject.connectSlotsByName(wind_add_prod)
    # setupUi

    def retranslateUi(self, wind_add_prod):
        wind_add_prod.setWindowTitle(QCoreApplication.translate("wind_add_prod", u"Adicionar Novo Produto", None))
        self.lb_codint.setText(QCoreApplication.translate("wind_add_prod", u"<html><head/><body><p align=\"right\">C\u00f3digo Interno</p></body></html>", None))
        self.lb_codforn.setText(QCoreApplication.translate("wind_add_prod", u"<html><head/><body><p align=\"right\">C\u00f3digo Fabricante</p></body></html>", None))
        self.lb_descprod.setText(QCoreApplication.translate("wind_add_prod", u"<html><head/><body><p align=\"right\">Descri\u00e7\u00e3o do Produto</p></body></html>", None))
        self.lb_forn.setText(QCoreApplication.translate("wind_add_prod", u"<html><head/><body><p align=\"right\">Fabricante</p></body></html>", None))
        self.pb_confirma_prod.setText(QCoreApplication.translate("wind_add_prod", u"Confirmar", None))
        self.pb_cancela_prod.setText(QCoreApplication.translate("wind_add_prod", u"Cancelar", None))
    # retranslateUi
